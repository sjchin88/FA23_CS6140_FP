...
pca = PCA()
pca.fit(X_imputed)
cvr = np.cumsum(pca.explained_variance_ratio_)  # cumulative explained variance ratio
...
print("the number of features in the transformed dataset: ", num_features_transformed)
...
model_save_path = "initial_run_impute_tss_PCA3"
models = [
